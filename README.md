...
In short: you are free to use, study, modify, redistribute, and even build a
commercial business around KoFEM — but if you distribute a modified version, **or
run a modified version as a network service** (for example, a hosted web app),
you must make the complete corresponding source code of your version available to
its users under the same license. This is the AGPL's defining feature: it closes
the "SaaS loophole" that an ordinary GPL leaves open.
